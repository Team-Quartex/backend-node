...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 25, 2024 at 05:47 AM
...
CREATE TABLE `notifications` (
  `notifyid` int(11) UNSIGNED NOT NULL,
  `userfrom` int(11) NOT NULL,
  `notifyfor` int(11) NOT NULL,
...
(1, 4, 1, 'follow', NULL, '2024-11-24 20:41:27', NULL, 'yes', NULL),
(2, 4, 3, 'follow', NULL, '2024-11-24 20:41:30', NULL, 'no', NULL),
(3, 4, 2, 'follow', NULL, '2024-11-24 20:41:33', NULL, 'yes', NULL),
(4, 4, 1, 'like', 'User 4 liked your post', '2024-11-24 20:41:35', 9, 'yes', NULL),
(5, 4, 3, 'like', 'User 4 liked your post', '2024-11-24 20:41:37', 8, 'no', NULL),
(6, 4, 2, 'like', 'User 4 liked your post', '2024-11-24 20:41:42', 7, 'yes', NULL),
(7, 4, 2, 'like', 'User 4 liked your post', '2024-11-24 20:41:46', 6, 'yes', NULL),
(8, 4, 1, 'like', 'User 4 liked your post', '2024-11-24 20:41:48', 4, 'yes', NULL),
(9, 2, 1, 'follow', NULL, '2024-11-24 20:42:59', NULL, 'yes', NULL);
...
(9, 1, 'hello', '', '2024-11-20 15:13:55', 'not'),
(10, 1, 'amazing', 'Devalahinda', '2024-11-24 21:31:02', 'not');
...
(10, '1-1732483861994-12-1731686005825-download.jpeg');
...
INSERT INTO `product_favourite` (`userId`, `productId`) VALUES
(1, 1),
(1, 3),
(1, 4),
(1, 6),
...
(1, 1, 1, 4, 'Nice Product', '', '2024-11-20 05:16:12'),
(2, 1, 2, 3, 'Nice Product', '', '2024-11-20 05:16:47'),
(3, 1, 3, 5, 'Nice Product', '', '2024-11-20 05:16:47');
...
(1, 3, 4, 1, '2024-11-23', '2024-11-25', '2024-11-21 01:41:56'),
(2, 6, 3, 2, '2024-11-25', '2024-11-26', '2024-11-21 01:42:40'),
(3, 2, 1, 5, '2024-11-24', '2024-11-27', '2024-11-22 20:37:04'),
(4, 1, 1, 3, '2024-11-26', '2024-11-29', '2024-11-22 20:39:33'),
(5, 1, 1, 3, '2024-11-25', '2024-11-29', '2024-11-23 14:06:09');
...
INSERT INTO `sellers` (`sid`, `name`, `business_name`, `email`, `address`, `city`, `username`, `password`, `status`, `profilepic`) VALUES
(1, 'Hansaka Ravisha', 'Inner pvt ltd', 'innertravel@gmail.com', '', '', 'inner@gmail.com', '12345', 'active', 'shan4.jpg'),
(2, 'Rasaja Perirs', 'Inner21 pvt ltd', 'innertrave21l@gmail.com', '', '', 'inner21', '12345', 'active', 'shan4.jpg'),
(3, 'Kavishka', 'In2121ner pvt ltd', 'innertrav2121el@gmail.com', '', '', 'inner2212121@gmail.com', '123425', 'active', 'shan4.jpg');
...
(1, 'hansaka2002', 'hansakaravi02@gmail.com', '$2a$10$jWyiDf8ENWll3Fj1fnRYhOPmSwTdREHxxGHBGAJ1248W0FXO3myZ6', 'Hansaka Ravishan ', '1-1732488075693-2024_10_19_14_44_IMG_5447.JPG', 'yes', '0712875690', ''),
...
(3, 'avishka2003', 'avishka@gmail.com', '$2a$10$RQQaD1S.wm1RJovPHec6Zu.CfpAz.RDJ5BXDGxTXvyLLF21yvgkDu', 'avishka Lakshan', 'sample.png', 'yes', NULL, NULL),
(4, 'kavee2002', 'kavee@gmail.com', '$2a$10$seTlfO6SjvpHNrMzPUDBQeoERvU0rNLUXTpTfakqYUZsDfTyR2oQq', 'kaveesha Udani', 'sample.png', 'no', NULL, NULL),
(5, 'nisha2002', 'nisha@gmail.com', '$2a$10$mmgvCIVUPt.3sIfzRBEAXOJax93616z7icICM0OsK9e15tOpIG572', 'Nishadi Supurnima', 'sample.png', 'no', NULL, NULL),
(6, 'wasana2002', 'wasu@gmail.com', '$2a$10$6dML3ixg1TX43j3C1F1b0uHWvIVfw28x/Ki0ZS2T6LnG.n4F7BO5C', 'wasu', 'sample.png', 'no', NULL, NULL);
...
ALTER TABLE `notifications`
  ...
  ADD KEY `notifyusers_idx` (`userfrom`,`notifyfor`),
  ADD KEY `notifyusers_notifyfor` (`notifyfor`),
  ADD KEY `postId_idx` (`postId`),
  ADD KEY `commentsnotify_idx` (`commentId`);
...
ALTER TABLE `product_favourite`
  ...
  ADD KEY `productFavourite_idx` (`productId`);
...
--
ALTER TABLE `notifications`
  MODIFY `notifyid` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `commentsnotify` FOREIGN KEY (`commentId`) REFERENCES `post_comments` (`commenId`) ON DELETE NO ACTION ON UPDATE NO ACTION,
